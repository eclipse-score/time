...
/**
 * @file
 * @brief Example: periodic HirsTime report printer.
 *
 * Uses HirsTimeHandler to obtain the current high-precision local steady time
 ...
 */
void PrintReport(const examples::time::hirs_time::TimeReport& report, std::uint64_t seq) noexcept
{
...
int main()
{
    ...
    examples::time::hirs_time::HirsTimeHandler handler;

    std::cout << "HirsTime printer started. Press Ctrl+C to stop.\n";
