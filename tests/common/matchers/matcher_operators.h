...
constexpr bool operator==(const TSync_TimeStampType& v1, const TSync_TimeStampType& v2) {
    return ((v1.timeBaseStatus == v2.timeBaseStatus) && (v1.secondsHi == v2.secondsHi) && (v1.seconds == v2.seconds) &&
            (v1.nanoseconds == v2.nanoseconds));
}
...
constexpr bool operator==(const TSync_VirtualLocalTimeType& v1, const TSync_VirtualLocalTimeType& v2) {
    return ((v1.nanosecondsHi == v2.nanosecondsHi) && (v1.nanosecondsLo == v2.nanosecondsLo));
}
...
constexpr bool operator==(const TSync_UserDataType& v1, const TSync_UserDataType& v2) {
    return (v1.userDataLength == v2.userDataLength && v1.userByte0 == v2.userByte0 && v1.userByte1 == v2.userByte1 &&
            v1.userByte2 == v2.userByte2);
}
