...
#if SCORE_EXTENSIONS
struct SCoreCfg {
	Boolean			autosar;					/* use the AUTOSAR profile specifics */

	double			GlobalTimePropagationDelay;	/* If cyclic propagation delay measurement is disabled, */
												/* this parameter replaces a measured propagation delay */
												/* by a fixed value. */
};
#endif
