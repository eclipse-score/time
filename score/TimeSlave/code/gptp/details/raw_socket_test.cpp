...
// ── FakeOsSyscalls ─────────────────────────────────────────────────────────────
//
// A controllable IOsSyscalls implementation that never touches the real OS.
// Each method has configurable return values; side-effects (like filling cmsg
// data) are controlled by boolean flags.

class FakeOsSyscalls final : public IOsSyscalls
{
  public:
    // ── socket ────────────────────────────────────────────────────────────────
...
void OpenSocket(RawSocket& sock, FakeOsSyscalls& /*fake*/)
{
    (void)sock.Open("eth0");
}
