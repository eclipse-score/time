...
.. document:: Time Daemon Architecture Inspection Checklist
  :id: doc__time_daemon_arc_inspection
  :status: draft
  :version: 1
  :safety: ASIL_B
  :security: YES
...
.. needtable::
   :filter: "time_daemon" in docname and "architecture" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_arc_sta
   :tags: time_daemon
