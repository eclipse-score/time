...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        FieldMutation<PtpStatus>{"is_synchronized",
                                 [](PtpStatus& value) {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        FieldMutation<SyncFupData>{"precise_origin_timestamp",
                                   [](SyncFupData& value) {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        FieldMutation<PDelayData>{"request_origin_timestamp",
                                  [](PDelayData& value) {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        FieldMutation<PtpTimeInfo>{"local_time",
                                   [](PtpTimeInfo& value) {
