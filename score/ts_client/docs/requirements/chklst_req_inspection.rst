...
.. document:: Time Sync Client Requirements Inspection Checklist
  :id: doc__ts_client_req_inspection
  :status: draft
  :version: 2
  :safety: ASIL_B
  :security: NO
...
.. needtable::
   :filter: "ts_client" in docname and "requirements" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_req
   :tags: ts_client
