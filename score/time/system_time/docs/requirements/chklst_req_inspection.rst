...
.. document:: SystemTime Requirements Inspection Checklist
  :id: doc__system_time_req_inspection
  :status: draft
  :version: 2
  :safety: ASIL_B
  :security: YES
...
.. attention::
    ...
    - Modify ``SystemTime`` to be your Component Name
...
.. needtable::
   :filter: "system_time" in docname and "requirements" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_req
   :tags: system_time
