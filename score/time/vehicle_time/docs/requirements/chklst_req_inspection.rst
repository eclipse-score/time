...
.. document:: VehicleTime Requirements Inspection Checklist
  :id: doc__vehicle_time_req_inspection
  :status: draft
  :version: 2
  :safety: ASIL_B
  :security: YES
...
.. needtable::
   :filter: "vehicle_time" in docname and "requirements" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_req
   :tags: vehicle_time
