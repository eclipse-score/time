...
.. document:: HighResSteadyTime Requirements Inspection Checklist
  :id: doc__high_res_steady_time_req_inspection
  :status: draft
  :version: 2
  :safety: ASIL_B
  :security: YES
...
.. attention::
    ...
    - Modify ``HighResSteadyTime`` to be your Component Name
...
.. needtable::
   :filter: "high_res_steady_time" in docname and "requirements" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_req
