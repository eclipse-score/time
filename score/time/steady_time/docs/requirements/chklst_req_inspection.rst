...
.. document:: SteadyTime Requirements Inspection Checklist
  :id: doc__steady_time_req_inspection
  :status: draft
  :version: 2
  :safety: ASIL_B
  :security: YES
...
.. attention::
    ...
    - Modify ``SteadyTime`` to be your Component Name
...
.. needtable::
   :filter: "steady_time" in docname and "requirements" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_req
   :tags: steady_time
