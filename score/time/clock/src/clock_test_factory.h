 ...
 ********************************************************************************/
#ifndef SCORE_TIME_CLOCK_SRC_CLOCK_TEST_FACTORY_H
#define SCORE_TIME_CLOCK_SRC_CLOCK_TEST_FACTORY_H
...
///   auto clock = ClockTestFactory<HighResSteadyTime>::Make(mock);
...
#endif  // SCORE_TIME_CLOCK_SRC_CLOCK_TEST_FACTORY_H
