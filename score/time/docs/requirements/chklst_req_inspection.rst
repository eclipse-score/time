...
.. document:: Time Requirements Inspection Checklist
  :id: doc__time_req_inspection
  :status: draft
  :version: 2
  :safety: ASIL_B
  :security: NO
...
.. needtable::
   :filter: "time" in docname and "requirements" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_req
   :tags: time
